...
import transChart from "../../assets/transaction.png"
...
<div className={`w-12 h-12 flex items-center justify-center text-[26px] text-white ${color} bg-purple-800 rounded-full drop-shadow-xl`} >
{icon}
</div>
<div>
